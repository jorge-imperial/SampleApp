...
public class UploadActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            this.pathFrontImage = b.getString("PathFrontImage");
            this.pathBackImage = b.getString("PathBackImage");

            // Deberia darle un segundo y comenzar transferencias...
            completed = 0;
            this.beginUpload(this.pathFrontImage);
            this.beginUpload(this.pathBackImage);
        }
    ...
    private void updateList() {
        ...
        if (completed == 2) {
            Log.d( TAG,"Ambas imagenes han sido enviadas.");
            this.FinishActivity();
        }
    }
    ...
    private void beginUpload(String filePath) {
        ...
        TransferObserver observer = transferUtility.upload(AppConfig.getS3BucketName(), file.getName(),
                file);
        /*
